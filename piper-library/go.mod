module github.wdf.sap.corp/ContinuousDelivery/piper-library
...
require (
	github.com/SAP/jenkins-library v1.469.0
...
require (
	...
	github.com/piper-validation/fortify-client-go v0.0.0-20220126145513-7b3e9a72af01 // indirect
