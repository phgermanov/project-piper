...
class SapPiperPublishNotificationsTest extends BasePiperTest {
    ...
    void init() throws Exception {
        ...
        JenkinsUtils.metaClass.static.addWarningsParser = { Script s, Map m ->
    ...
    void testPublishNotifications() throws Exception {
        ...
        // asserts
        assertThat(jlr.log, containsString('[sapPiperPublishNotifications] New Warnings plugin parser \'Piper Notifications Parser\' configuration added.'))
